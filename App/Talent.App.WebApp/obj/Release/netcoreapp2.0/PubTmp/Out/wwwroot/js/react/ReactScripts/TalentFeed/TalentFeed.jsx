...
export default class TalentFeed extends React.Component {
    ...
    loadData() {
        ...
        var localUrl = 'https://talentservicesprofile20230525024446.azurewebsites.net/profile/profile/getTalent'
        $.ajax({
            url: localUrl,
            headers: {
    ...
    loadEmployerProfile() {
        var cookies = Cookies.get('talentAuthToken');
        var localUrl = 'https://talentservicesprofile20230525024446.azurewebsites.net/profile/profile/getEmployerProfile';
